...
//	cout << "musicDB::CommitSongsToLibrary"  << endl;
	sprintf(SQLStmt, "INSERT into Music.songlibrary (Name ,Artist, Composer, AlbumArtists ,Album, Grouping, SongYear, Location, TrackNumber, Genre,  SongTime, BitRate, SampleRate, DateModified, DateAdded, AlbumId, ArtistId) select Name ,Artist ,Composer, AlbumArtists ,Album, Grouping, SongYear, Location, TrackNumber, Genre,  SongTime, BitRate, SampleRate, DateModified, DateAdded, AlbumId, ArtistId from Music.presonglibrary");
	if (mysql_query(&dbaseConnection, SQLStmt))
	{
